...
public class WorkflowOutlineContextMenuProvider extends ContextMenuProvider implements ContentChangeListener<WorkflowDiagram> {
    private Project project;
    private WorkflowDiagram diagram;

    public WorkflowOutlineContextMenuProvider(Project project) {
